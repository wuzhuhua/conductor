...
public abstract class AbstractProtoMapper {
    ...
    public EventHandlerPb.EventHandler.StartWorkflow toProto(EventHandler.StartWorkflow from) {
        ...
        if (from.getEntityType() != null) {
            to.setEntityType( from.getEntityType() );
        }
        if (from.getEntityMaxEntryCount() != null) {
            to.setEntityMaxEntryCount( from.getEntityMaxEntryCount() );
        }
        if (from.getExecMode() != null) {
            to.setExecMode( from.getExecMode() );
        }
        to.setStopInEffectAfterEpochSecond( from.getStopInEffectAfterEpochSecond() );
        if (from.getExecLimitIntervalInSeconds() != null) {
            to.setExecLimitIntervalInSeconds( from.getExecLimitIntervalInSeconds() );
        }
        return to.build();
    }
    ...
    public EventHandlerPb.EventHandler.TaskDetails toProto(EventHandler.TaskDetails from) {
        ...
        if (from.getWorkflowDef() != null) {
            to.setWorkflowDef( from.getWorkflowDef() );
        }
        return to.build();
    }
    ...
    public EventHandlerPb.EventHandler.Action toProto(EventHandler.Action from) {
        ...
        if (from.getTrigger_task() != null) {
            to.setTriggerTask( toProto( from.getTrigger_task() ) );
        }
        return to.build();
    }
    ...
    public EventHandler.Action fromProto(EventHandlerPb.EventHandler.Action from) {
        ...
        if (from.hasTriggerTask()) {
            to.setTrigger_task( fromProto( from.getTriggerTask() ) );
        }
        return to;
    }
    ...
    public EventHandlerPb.EventHandler.Action.Type toProto(EventHandler.Action.Type from) {
        ...
        switch (from) {
            ...
            case trigger_task: to = EventHandlerPb.EventHandler.Action.Type.TRIGGER_TASK; break;
            default: throw new IllegalArgumentException("Unexpected enum constant: " + from);
        }
        return to;
    }
    ...
    public EventHandler.Action.Type fromProto(EventHandlerPb.EventHandler.Action.Type from) {
        ...
        switch (from) {
            ...
            case TRIGGER_TASK: to = EventHandler.Action.Type.trigger_task; break;
            default: throw new IllegalArgumentException("Unexpected enum constant: " + from);
        }
        return to;
    }
