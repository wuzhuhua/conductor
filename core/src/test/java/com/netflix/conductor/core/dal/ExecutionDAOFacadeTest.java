...
public class ExecutionDAOFacadeTest {
    ...
    public void setUp() {
        ...
        CountLimitingDAO countLimitingDAO=mock(CountLimitingDAO.class);
        ...
        JourneyInsightWriter jiWriter=mock(JourneyInsightWriter.class);
        executionDAOFacade =
                new ExecutionDAOFacade(
                        ...
                        objectMapper,
                        properties,
                        externalPayloadStorageUtils,jiWriter);
    }
