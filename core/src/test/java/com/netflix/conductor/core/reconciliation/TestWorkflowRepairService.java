...
public class TestWorkflowRepairService {
    ...
    public void setUp() {
        ...
        workflowRepairService =
                new WorkflowRepairService(executionDAO, queueDAO, properties, systemTaskRegistry,executionDAOFacade);
    }
    ...
    public void verifyAndRepairParentWorkflow() {
        ...
        when(executionDAOFacade.getWorkflowModel("abcd", true)).thenReturn(workflow);
        when(queueDAO.containsMessage(anyString(), anyString())).thenReturn(false);
