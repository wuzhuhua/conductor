...
public interface ExecutionDAO {
    ...
    String[] getTaskCorrIdMappings(String workflowType,String taskRefName,String corrId);

    void addTaskCorrIdMappings(TaskModel task);

    void removeTaskCorrIdMappings(TaskModel task);

    void removeTaskMappings(TaskModel task);
    /**
    ...
    List<String> getTasksIdForWorkflow(String workflowId);
    /**
    ...
    boolean removeWorkflowAndTask(String workflowId,List<String> taskIds, int ttlSeconds);
    ...
    List<String> getWfIdsByCorrelationId(
    ...
    long getLatestFinishTimestampByCorrelationId(String correlationId);

    void removeWorkflowRef(WorkflowModel workflow);
