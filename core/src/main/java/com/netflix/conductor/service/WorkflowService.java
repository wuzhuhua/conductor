...
public interface WorkflowService {
    ...
    TaskSummary getFirstRunningWorkflowIdByCorrelationId(
            @NotEmpty(message = "Workflow name cannot be null or empty") String name,
    ...
    List<String> getRunningWorkflows(
            @NotEmpty(message = "Workflow name cannot be null or empty.") String workflowName,
            @NotEmpty(message = "Correlation id cannot be null or empty.") String correlationId);
    ...
    long getLatestFinishTimestampByCorrelationId(String correlationId) throws NotFoundException;

    List<String> runningWfIdsByCorrelationId(String correlationId);

    void removePendingWorkflowExecution(String workflowName);

    void removeWorkflowFromDeciderQueue(String workflowId);

    void updateIndexStatus(String workflowId);

    Workflow getExecutionStatusFromRedis(String workflowId, boolean includeTasks);

    Object getRedisByKey(String key);

    boolean removeRedis(String taskId, String workflowId);

    void cleanupRedisByKey(String key,String value,Boolean isHash,Boolean isSet);
