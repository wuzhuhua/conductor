...
public class ConductorProperties {
    ...
    @DurationUnit(ChronoUnit.SECONDS)
    private Duration ttlRedisKeyExpire = Duration.ofSeconds(3600);

    public Duration getTtlRedisKeyExpire() {
        return ttlRedisKeyExpire;
    }

    public void setTtlRedisKeyExpire(Duration ttlRedisKeyExpire) {
        this.ttlRedisKeyExpire = ttlRedisKeyExpire;
    }

    private boolean enableRemoveRedisKey = false;

    public boolean getEnableRemoveRedisKey() {
        return enableRemoveRedisKey;
    }

    public void setEnableRemoveRedisKey(Boolean enableRemoveRedisKey) {
        this.enableRemoveRedisKey = enableRemoveRedisKey;
    }

    private String[] workflowCleanupIds;

    public String[] getWorkflowCleanupIds() {
        return workflowCleanupIds;
    }

    public void setWorkflowCleanupIds(String[] workflowCleanupIds) {
        this.workflowCleanupIds = workflowCleanupIds;
    }
    /**
