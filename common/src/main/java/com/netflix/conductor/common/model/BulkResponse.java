...
public class BulkResponse {
    ...
    public static BulkResponse mergeResponses(List<BulkResponse> responses) {
        BulkResponse mergedResponse = new BulkResponse();

        for (BulkResponse response : responses) {
            mergedResponse.bulkSuccessfulResults.addAll(response.getBulkSuccessfulResults());
            mergedResponse.bulkErrorResults.putAll(response.getBulkErrorResults());
        }
