...
public class EventHandler {
    ...
    public static class Action {
        ...
        @ProtoField(id = 6)
        private TaskDetails trigger_task;

        public TaskDetails getTrigger_task() {
            return trigger_task;
        }

        public void setTrigger_task(TaskDetails trigger_task) {
            this.trigger_task = trigger_task;
        }
    ...
    public static class StartWorkflow {
        ...
        @ProtoField(id = 8)
        private Integer entityMaxEntryCount;

        public Integer getEntityMaxEntryCount() {
            return entityMaxEntryCount;
        }

        public void setEntityMaxEntryCount(Integer entityMaxEntryCount) {
            this.entityMaxEntryCount = entityMaxEntryCount;
        }

        @ProtoField(id = 9)
        private Integer execMode;

        public Boolean getFlushPreviousCorrIdRunningWf() {
            return isFlushPreviousCorrIdRunningWf;
        }

        public void setFlushPreviousCorrIdRunningWf(Boolean flushPreviousCorrIdRunningWf) {
            isFlushPreviousCorrIdRunningWf = flushPreviousCorrIdRunningWf;
        }

        private Boolean isFlushPreviousCorrIdRunningWf = false;


        public long getStopInEffectAfterEpochSecond() {
            return stopInEffectAfterEpochSecond;
        }

        public void setStopInEffectAfterEpochSecond(long stopInEffectAfterEpochSecond) {
            this.stopInEffectAfterEpochSecond = stopInEffectAfterEpochSecond;
        }

        @ProtoField(id = 10)
        private long stopInEffectAfterEpochSecond;

        public Integer getExecLimitIntervalInSeconds() {
            return execLimitIntervalInSeconds;
        }

        public void setExecLimitIntervalInSeconds(Integer execLimitIntervalInSeconds) {
            this.execLimitIntervalInSeconds = execLimitIntervalInSeconds;
        }

        @ProtoField(id = 11)
        private Integer execLimitIntervalInSeconds;
