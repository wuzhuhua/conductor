...
//    private final AmazonSQS client;
    ...
    public SQSEventQueueProvider(
            SQSEventQueueProperties properties, Scheduler scheduler,QueueDAO queueDAO) {
//        this.client = client;
        this.batchSize = properties.getBatchSize();
        this.pollTimeInMS = properties.getPollTimeDuration().toMillis();
        this.internalSize=properties.getInternalSize();
...
//                                .withClient(client)
                                ...
                                .withInternalSize(internalSize)
                                .withQueueDAO(queueDAO)
                                .build());
    }
}
