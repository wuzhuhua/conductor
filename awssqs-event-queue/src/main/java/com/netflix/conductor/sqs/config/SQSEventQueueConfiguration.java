...
//    }
    @Bean
    public EventQueueProvider sqsEventQueueProvider(SQSEventQueueProperties properties, Scheduler scheduler) {
        return new SQSEventQueueProvider( properties, scheduler,queueDAO);
    }
    ...
    public Map<Status, ObservableQueue> getQueues(
        ...
        for (Status status : statuses) {
            ...
            Builder builder = new Builder().withQueueDAO(queueDAO).withQueueName(queueName);
