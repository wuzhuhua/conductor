...
public class WorkflowClient extends ClientBase {
    ...
    public void removePendingWorkflow(String workflowName) {
        Validate.notNull(workflowName , "workflowName cannot be null");
        delete("workflow/removePendingWorkflowExecution/{workflowName}",workflowName);
    }
    
    public BulkResponse terminatePendingWorkflowExecutions(String wfName, Integer version, String reason,Integer batchSize,
                                                           Integer batchIntervalInMs) {
        Object[] params =
                new Object[] {
                        "version", version, "reason", reason, "batchSize", batchSize, "batchIntervalInMs", batchIntervalInMs
                };
        return postForEntity(
                "workflow/terminatePendingWorkflowExecutions/{workflowName}",
                null,
                params,
                BulkResponse.class,
                wfName);
