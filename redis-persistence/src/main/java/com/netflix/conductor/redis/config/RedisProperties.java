...
public class RedisProperties {
    ...
    /** connect to Redis hosts with SSL enables. It applies to all hosts */
    private boolean isSSL = false;

    private boolean isQueueRedisSSL = false;
    ...
    public boolean isQueueRedisSSL() {
        return isQueueRedisSSL;
    }

    public void setIsQueueRedisSSL(boolean isQueueRedisSSL) {
        isQueueRedisSSL = isQueueRedisSSL;
    }
}
